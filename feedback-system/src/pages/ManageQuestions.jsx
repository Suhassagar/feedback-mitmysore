...
export default function ManageQuestions() {
  ...
  return (
    <PageTransition>
                  ...
                  {headingQuestions.length === 0 ? (
                    ...
                    <div className="flex-col" style={{ gap: "8px" }}>
                      {headingQuestions.map((q, idx) => (
                        <div key={q.question_id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", border: "1px solid #F1F5F9", background: "#fff", borderRadius: "8px" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                            <div style={{ color: "#94A3B8", fontWeight: "600", fontSize: "13px", width: "24px" }}>
                              Q{idx + 1}.
                            </div>
                            <div>
                              <h4 style={{ margin: "0", fontSize: "14px", color: "var(--text-primary)", fontWeight: "500" }}>{q.question_text}</h4>
                            </div>
                          </div>
      ...
      {/* MODAL: ADD HEADING */}
      {showAddHeadingModal && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.4)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, animation: "fadeIn 0.2s" }}>
