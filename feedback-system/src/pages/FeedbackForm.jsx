      ...
      <div className="theme-student container flex-col feedback-container">
        ...
        <div className="flex-col gap-lg" style={{ maxWidth: "800px", margin: "0 auto", width: "100%" }}>
          ...
          {!isFinalStep && currentFaculty && (
            <div className="card glass-modal" style={{ width: "100%", maxWidth: "800px", background: "#ffffff", borderRadius: "24px", padding: "var(--space-24)", boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.05)" }}>
              <div className="flex-col gap-xl">
                <div className="card" style={{ padding: "var(--space-24)", borderTop: "5px solid var(--navy)", animation: "fadeIn 0.4s" }}>
          ...
          {/* FINAL STEP: REMARKS */}
          {isFinalStep && (
            <div className="card" style={{ padding: "40px 30px", borderTop: "5px solid var(--gold)", animation: "fadeIn 0.4s", textAlign: "center" }}>
