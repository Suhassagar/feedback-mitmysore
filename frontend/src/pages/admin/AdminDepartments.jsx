...
export default function AdminDepartments() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "30px", maxWidth: "1400px", margin: "0 auto", width: "100%" }}>
      <div className="admin-dept-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "16px", borderBottom: "1px solid #E5E7EB", paddingBottom: "20px" }}>
        <div>
            ...
            return (
              ...
              >
                ...
                <div style={{ opacity: dept.is_active === 1 ? 1 : 0.4, transition: "opacity 0.3s", filter: dept.is_active === 1 ? "none" : "grayscale(100%)", flex: 1, display: "flex", flexDirection: "column" }}>
                  {/* Header Section */}
                  <div className="dept-card-header" style={{ padding: "24px 24px 20px 24px", borderBottom: "1px solid #F3F4F6", display: "flex", alignItems: "flex-start", justifyContent: "space-between", paddingRight: "100px" }}>
                  <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "10px", marginTop: "6px" }}>
                        <span style={{ fontSize: "13px", color: "var(--text-muted)", fontWeight: "500" }}>Academic Department</span>
