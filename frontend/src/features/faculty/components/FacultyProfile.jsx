    ...
    <div className="flex-col gap-md" style={{ width: "100%", animation: "fadeIn 0.3s" }}>
      <style>
        {`
          @media (max-width: 640px) {
            ...
            .faculty-subject-item > div:last-child {
              width: 100%;
      ...
      <div className="dash-grid-2-1" style={{ alignItems: "flex-start" }}>
        <div className="flex-col" style={{ gap: "24px" }}>
          ...
          <div className="card faculty-profile-header-card" style={{ padding: "32px", display: "flex", alignItems: "center", borderRadius: "16px", background: "linear-gradient(to right, #ffffff, #f8fafc)", position: "relative" }}>
            <div className="faculty-header-actions" style={{ position: "absolute", top: "16px", right: "16px", display: "flex", gap: "8px" }}>
              <button 
                className="btn" 
                title="Edit Profile"
            ...
            <div className="faculty-profile-main" style={{ display: "flex", alignItems: "center", gap: "24px" }}>
              ...
              <div>
                <h2 className="faculty-profile-name" style={{ margin: "0 0 8px 0", fontSize: "28px", fontWeight: "800", color: "var(--text-primary)" }}>{selectedFaculty.name}</h2>
                <div className="faculty-badges-wrap" style={{ display: "flex", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div className="card faculty-assigned-card" style={{ padding: "32px", borderRadius: "16px" }}>
              ...
              <div className="flex-col" style={{ gap: "12px" }}>
                {assignedSubjects.map((sub, idx) => (
                  <div key={idx} className="flex-col" style={{ border: "1px solid var(--border-color)", background: "#fff", borderRadius: "12px", overflow: "hidden" }}>
                    <div 
                      className={`hoverable faculty-subject-item ${sub.avg_rating ? 'clickable-card' : ''}`} 
          ...
          <div className="card" style={{ padding: "24px", borderRadius: "16px" }}>
            ...
            <div className="flex-col" style={{ gap: "20px", fontSize: "14px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", gap: "16px" }}>
                ...
                <span style={{ fontWeight: "600", color: "#0F172A", textAlign: "right", wordBreak: "break-word" }}>{facultyAnalytics?.profile?.dept_name || deptName || dept_id}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", gap: "16px" }}>
